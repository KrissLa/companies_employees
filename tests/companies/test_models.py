...
@pytest.mark.django_db
def test_company_get_number_of_offices(
    default_company: Company, add_office: Callable
) -> None:
    """
    Тест метода get_number_of_offices модели Company
    """
    add_office()
    add_office()
...
@pytest.mark.django_db
def test_company_get_number_of_employees_1(
    default_company: Company, add_position: Callable
) -> None:
    """
    Тест метода get_number_of_employees модели Company
    """
    add_position()
    add_position()
    add_position()
...
@pytest.mark.django_db
def test_company_get_number_of_employees_3(
    default_company: Company, add_user: Callable, add_position: Callable
) -> None:
    """
    Тест метода get_number_of_employees модели Company
    """
...
def test_office_model(
    ...
    assert (
        str(default_office) == f"Офис {default_office.name} "
